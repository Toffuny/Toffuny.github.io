(self.webpackChunk = self.webpackChunk || []).push([
    ["981"], {
        5487: function() {
            ...
            window.tram = function(e) {
                ...
                var M = t.frame = (s = p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame || p.oRequestAnimationFrame || p.msRequestAnimationFrame) && C.bind ? s.bind(p) : function(e) {
                    ...
                    F = t.now = (c = (l = p.performance) && (l.now || l.webkitNow || l.msNow || l.mozNow)) && C.bind ? c.bind(l) : Date.now || function() {
                        return +new Date
                    },
                    P = u(function(t) {
                        function n(e, t) {
                        ...
                        t.init = function(t) {
                            ...
                            C.backface && X.hideBackface && W(this.el, C.backface.css, "hidden")
                        ...
                        }), E("next", r), E("stop", s), E("set", function(e) {
                            s.call(this, e), d.call(this, e, p, h)
                        }), E("show", function(e) {
                            "string" != typeof e && (e = "block"), this.el.style.display = e
                        }), E("hide", l), E("redraw", c), E("destroy", function() {
                    ...
                    V = u(function(t) {
                        function a() {
                            ...
                            if (i)
                                for (M(a), t = F(), e = i; e--;)(n = l[e]) && n.render(t)
                        }
                        var s = {
                            ease: d.ease[1],
                            from: 0,
                        ...
                        t.init = function(e) {
                            ...
                            this.active || (this.start || (this.start = F()), this.active = !0, 1 === l.push(this) && M(a))
                        }, t.stop = function() {
                            var t, n;
                ...
                C.transform && (H.transform = [G], Y = {
                    ...
                    skewX: [v],
                    skewY: [v]
                }), C.transform && C.backface && (Y.z = [T, "translateZ"], Y.rotateZ = [v], Y.scaleZ = [E], Y.perspective = [b]);
                var Q = /ms/,
                    K = /s|\./;
                return e.tram = t
            }(window.jQuery)
        ...
        5756: function(e, t, n) {
            "use strict";
            var i, r, a, o, s, l, c, u, d, f, p, g, h, m, E, y, b, T, v, I, O = window.$,
                _ = n(5487) && O.tram;
            (i = {}).VERSION = "1.6.0-Webflow", r = {}, a = Array.prototype, o = Object.prototype, s = Function.prototype, a.push, l = a.slice, a.concat, o.toString, c = o.hasOwnProperty, u = a.forEach, d = a.map, a.reduce, a.reduceRight, f = a.filter, a.every, p = a.some, g = a.indexOf, a.lastIndexOf, h = Object.keys, s.bind, m = i.each = i.forEach = function(e, t, n) {
                if (null == e) return e;
                ...
                return "\\" + b[e]
            }, I = /^\s*(\w|\$)+\s*$/, i.template = function(e, t, n) {
                !t && n && (t = n);
                ...
                e.replace(a, function(t, n, i, r, a) {
                    return s += e.slice(o, a).replace(T, v), o = a + t.length, n ? s += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : i ? s += "'+\n((__t=(" + i + "))==null?'':__t)+\n'" : r && (s += "';\n" + r + "\n__p+='"), t
                }), s += "';\n";
                var l = t.variable;
                if (l) {
                    if (!I.test(l)) throw Error("variable is not a bare identifier: " + l)
                } else s = "with(obj||{}){\n" + s + "}\n", l = "obj";
        ...
        3949: function(e, t, n) {
            ...
            var b = navigator.userAgent.toLowerCase(),
                ...
                v = a.env.chrome = /chrome/.test(b) && /Google/.test(navigator.vendor) && parseInt(b.match(/chrome\/(\d+)\./)[1], 10),
                I = a.env.ios = /(ipod|iphone|ipad)/.test(b);
            a.env.safari = /safari/.test(b) && !v && !I, T && d.on("touchstart mousedown", function(e) {
                i = e.target
            ...
            a.resize = w(u, O), a.scroll = w(u, _), a.redraw = w(), a.location = function(e) {
                window.location = e
            }, a.env() && (a.location = function() {}), a.ready = function() {
                h = !0, m ? (m = !1, p.each(o, E)) : p.each(s, S), p.each(l, S), a.resize.up()
            }, a.load = function(e) {
                r.then(e)
            }, a.destroy = function(e) {
                e = e || {}, m = !0, u.triggerHandler("__wf_destroy"), null != e.domready && (h = e.domready), p.each(o, y), a.resize.off(), a.scroll.off(), a.redraw.off(), s = [], l = [], "pending" === r.state() && R()
                    ...
                    for (var t = document.links, o = 0; o < t.length; ++o) ! function(t) {
                        if (!t.getAttribute("hreflang")) {
                            ...
                            if (u.href = i, !(i.indexOf(":") >= 0)) {
                                ...
                                "#" !== i && "" !== i && h(o, d, u.href === c.href || i === a || f.test(i) && p.test(a))
                            }
                        }
                    }(t[o]);
            ...
            i.define("scroll", e.exports = function(e) {
                ...
                return {
                    ready: function() {
                        ...
                        o.on(n, f, E), o.on(e, d, function(e) {
                            e.preventDefault()
        ...
        1970: function(e, t, n) {
            ...
            function ee(e, t) {
                ...
                if (ei({
                    ...
                    c && e && t.dispatch((0, h.actionListPlaybackChanged)({
                        actionListId: i,
                        isPlaying: !s
                    }))
                }
                        ...
                        es(e), (0, d.default)(n, (t, n) => {
                            ...
                            ! function({
                                ...
                                (0, d.default)(u, (e, i) => {
                                    ...
                                    W(d, l.mediaQueryKeys) || t.dispatch((0, h.mediaQueriesDefined)()), s.actionTypeId === p.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION && (Array.isArray(r.config) ? r.config : [r.config]).forEach(n => {
                                        let {
                                    ...
                                    }), (s.actionTypeId === p.ActionTypeConsts.GENERAL_START_ACTION || v(s.actionTypeId)) && ed({
                                        store: t,
                                        actionListId: f,
                                        eventId: u
                                    })
                                ...
                                let g = e => {
                                        ...
                                        ec(u, (a, o, s) => {
                                            ...
                                            let g = (n = {}) => {
                                                ...
                                                z(i, u) || t.dispatch((0, h.eventStateChanged)(s, i))
                                            };
            ...
            function ef({
                ...
                (0, d.default)(t, t => {
                    if (!t.continuous) {
                        ...
                        em(t, e), i && e.dispatch((0, h.actionListPlaybackChanged)({
                            actionListId: n,
                            isPlaying: !1
                        }))
                    }
            ...
            function ep({
                ...
                (0, d.default)(a, n => {
                    ...
                    if (n.actionListId === r && n.eventId === t && s) {
                        ...
                        em(n, e), n.verbose && e.dispatch((0, h.actionListPlaybackChanged)({
                            actionListId: r,
                            isPlaying: !1
                        }))
                    }
            ...
            function eg({
                ...
                a >= g.length && (0, o.default)(f, "config.loop") && (a = 0), 0 === a && h && a++;
                let E = (0 === a || 1 === a && h) && v(f.action?.actionTypeId) ? f.config.delay : void 0,
                    y = (0, o.default)(g, [a, "actionItems"], []);
                if (!y.length || !V(p, u.mediaQueryKey)) return !1;
                let b = u.hasBoundaryNodes && n ? m.getClosestElement(n, O) : null,
                    T = P(y),
                    I = !1;
            ...
            function eh(e) {
                let t, {
                    ...
                    v = m.getRefType(a),
                    I = E.reducedMotion && p.ReducedMotionTypes[o.actionTypeId];
                if (I && c) switch (y.events[d]?.eventTypeId) {
                ...
                N({
                    ...
                    onChange: ey
                }), c || n.dispatch((0, h.instanceStarted)(f, E.tick))
            }
            ...
            function em(e, t) {
                ...
                o === _ && B(a, i, m), t.dispatch((0, h.instanceRemoved)(e.id))
            }
            ...
            function ey(e, t) {
                let {
                    ...
                    mediaQueries: S = v.mediaQueryKeys
                } = O && O[d] ? O[d] : {};
                if (V(S, I.mediaQueryKey) && (i || n || r)) {
                    if (c || l === w && r) {
        ...
        8955: function(e, t, n) {
            ...
            let {
                ...
                PAGE_START: k,
                PAGE_SCROLL: x
            } = s.EventTypeConsts, D = "COMPONENT_ACTIVE", U = "COMPONENT_INACTIVE", {
                COLON_DELIMITER: G
                ...
                element: e,
                nativeEvent: t
            }) => e.contains(t.target)), W = (0, r.default)([j, X]), z = (e, t) => {
                if (t) {
                    let {
                        ixData: n
                    } = e.getState(), {
                ...
                let {
                    type: i
                } = t.nativeEvent, r = -1 !== [D, U].indexOf(i) ? i === D : n.isActive, a = {
                    ...n,
                    isActive: r
                };
                ...
                ...K,
                handler: Y(e ? W : j, ea((e, t) => t.isActive ? Q.handler(e, t) : t))
            }), ed = (e = !0) => ({
                ...K,
                handler: Y(e ? W : j, ea((e, t) => t.isActive ? t : Q.handler(e, t)))
            }), ef = {
                ...J,
                handler: (i = (e, t) => {
                    let {
                    ...
                    return !o[i.action.config.autoStopEventId] && t.triggered ? t : i.eventTypeId === A === n ? (H(e), {
                        ...t,
                        triggered: !0
                    }) : t
                }, (e, t) => {
                ...
                [S]: {
                    ...
                    handler: ({
                        ...
                        let {
                            ...
                            pageX: h = a.pageX,
                            pageY: m = a.pageY
                        } = i, E = "X_AXIS" === l, y = "mouseout" === i.type, b = f / 100, T = u, v = !1;
                        switch (o) {
                            ...
                            case s.EventBasedOn.PAGE: {
                                ...
                                b = E ? Math.min(e + h, n) / n : Math.min(t + m, i) / i;
                                break
                            }
                        ...
                        return y && (b > .95 || b < .05) && (b = Math.round(b)), (o !== s.EventBasedOn.ELEMENT || v || v !== a.elementHovered) && (b = d ? 1 - b : b, e.dispatch((0, c.parameterChanged)(T, b))), {
                            elementHovered: v,
                            clientX: p,
                            clientY: g,
                            pageX: h,
        ...
        7718: function(e, t, n) {
            ...
            let i = n(7087),
                ...
                T = (e, t) => {
                    ...
                    null != g && (T = g), v = null != m ? m : v, s === h ? T = 0 : (o || y) && (T = v = 0);
                    let {
                        now: I
                    } = t.payload;
                    if (n && i) {
                    ...
                    switch (t.type) {
                        ...
                        case l: {
                            let {
                                ...
                                actionTypeId: C
                            } = r, N = E(C), L = y(N, C), M = Object.keys(p).filter(e => null != p[e] && "string" != typeof p[e]), {
                                easing: F
                            } = r.config;
                            return (0, a.set)(e, n, {
                                id: n,
        ...
        4124: function(e, t, n) {
            ...
            function eT({
                ...
                if (Array.isArray(l) && l.length > 0) return l.reduce((e, a) => e.concat(eT({
                    config: {
                        target: a
                    },
                    event: t,
                ...
                let S = (t?.action?.config?.affectedElements ?? {})[T || I] || {},
                    R = !!(S.id || S.selector),
                    A = t && d(eb(t.target));
                if (R ? (a = S.limitAffectedElements, o = A, s = d(S)) : o = s = d({
                        id: T,
                        selector: I,
                        selectorGuids: O
                    }), t && w) {
                    let e = n && (s || !0 === w) ? [n] : f(A);
                    if (s) {
                        if (w === D) return f(s).filter(t => e.some(e => E(t, e)));
                        if (w === P) return f(s).filter(t => e.some(e => E(e, t)));
                        if (w === x) return f(s).filter(t => e.some(e => y(e, t)))
                    }
                    return e
                }
                return null == o || null == s ? [] : g.IS_BROWSER_ENV && i ? f(s).filter(e => i.contains(e)) : a === P ? f(o, s) : a === k ? p(f(o)).filter(m(s)) : a === x ? h(f(o)).filter(m(s)) : f(s)
            }
                ...
                switch (i.actionTypeId) {
                    ...
                    case et: {
                        let t, r = o(e, C),
                            s = o(e, N);
                        return {
                            widthValue: i.config.widthUnit === V ? eI.test(r) ? parseFloat(r) : parseFloat(n.width) : (0, a.default)(parseFloat(r), parseFloat(n.width)),
                            heightValue: i.config.heightUnit === V ? eI.test(s) ? parseFloat(s) : parseFloat(n.height) : (0, a.default)(parseFloat(s), parseFloat(n.height))
                        }
                    }
                    case en:
                    case ei:
            ...
            function eN(e) {
                return /^TRANSFORM_/.test(e) ? W : /^STYLE_/.test(e) ? $ : /^GENERAL_/.test(e) ? z : /^PLUGIN_/.test(e) ? H : void 0
            }
            ...
            function eM(e, t, n, i, r, a, s, l, c) {
                switch (l) {
                    case W:
                        ...
                        eV(u, g.TRANSFORM_PREFIXED, m), S(u, g.TRANSFORM_PREFIXED, E),
                            function({
                                actionTypeId: e
                            }, {
                                xValue: t,
                            ...
                            }(h, f) && S(u, g.TRANSFORM_STYLE_PREFIXED, _);
                        return;
                    case $:
                        return function(e, t, n, i, r, a) {
                            ...
                            switch (i.actionTypeId) {
                                case et: {
                                    ...
                                    void 0 !== o && (t === V && (t = "px"), eV(e, C, a), s(e, C, o + t)), void 0 !== l && (r === V && (r = "px"), eV(e, N, a), s(e, N, l + r));
                                    break
                                }
                                case J:
                                    var l = i.config;
                                ...
                                case er: {
                                    let t = el[i.actionTypeId],
                                        ...
                                        c = n.aValue;
                                    eV(e, t, a), s(e, t, c >= 1 ? `rgb(${r},${o},${l})` : `rgba(${r},${o},${l},${c})`);
                                    break
                                }
                                default: {
                                    let {
                    ...
                    case z:
                        ...
                        if (M.actionTypeId === ea) {
                            ...
                            P(L, U, e === w && g.IS_BROWSER_ENV ? g.FLEX_PREFIXED : e);
                        }
                        return;
                    case H: {
                        let {
            ...
            function eV(e, t, n) {
                ...
                let s = o.split(B).map(es); - 1 === s.indexOf(i) && a(e, G, s.concat(i).join(B))
            }
            ...
            function eB(e, t, n) {
                ...
                o && -1 !== o.indexOf(i) && a(e, G, o.split(B).map(es).filter(e => e !== i).join(B))
            }
                ...
                I = (e = v, t = {}) => {
                    switch (t.type) {
                        ...
                        case b: {
                            ...
                            return (0, a.getIn)(c, [n, i]) !== i && (c = O(c, i, s, n, o)), _(c, n, l, r, o)
                        }
                        case T: {
                            let {
                                elementId: n,
        ...
        9845: function(e, t, n) {
            ...
            class s {
                ...
                observe(e, t) {
                    ...
                    let l = async () => t(await this.evaluate(e)), c = [];
                    return o.forEach(e => {
                        let t = s.breakpointQueries[e];
        ...
        3922: function(e, t) {
            ...
            class o extends Error {
                ...
                scope;
                constructor(e, t, n) {
                    super(e), this.selector = t, this.scope = n, this.name = "IX3SelectorError"
                }
            }
            ...
            let u = e => `[data-wf-target*="${CSS.escape(`[${JSON.stringify(e)}`)}"]`
        },
        4574: function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            function s(e) {
                e.addTargetResolver("id", {
                    ...
                    resolve: ([, e], {
                        ...
                        let [n, r] = e, s = Array.isArray(n), c = s ? r : void 0, u = s ? (0, i.pair)(n[0], n[1]) : (0, i.pair)(n, r), d = (0, a.safeQuerySelectorAll)((0, a.elementTargetSelector)(u), document);
                        ...
                        try {
                            ...
                            let r = (0, i.getSecond)(n),
                                a = f.filter(e => (e.dataset.wfTarget || "").includes(`${JSON.stringify(r)}]`));
                            return l(a, c)
                        } catch (e) {
                            return o
                        }
            ...
            function l(e, t) {
                ...
                if (Array.isArray(t)) {
                    ...
                    switch (i) {
                        ...
                        case r.TargetScope.FIRST_DESCENDANT: {
                            let t = [];
                            for (let n of e) {
                                let e = o ? (0, a.safeQuerySelector)(o, n) : n.firstElementChild;
                                e && t.push(e)
                            }
                            return t
                        }
                        case r.TargetScope.DESCENDANTS: {
                            let t = [];
                            for (let n of e)
                                for (let e of (0, a.safeQuerySelectorAll)(o, n) || []) t.push(e);
                            return t
                        }
                        case r.TargetScope.ANCESTORS: {
                            ...
                            for (let n of e) {
                                ...
                                for (; e;)(!o || (0, a.safeMatches)(e, o)) && t.push(e), e = e.parentElement
                            }
                            return t
                        }
                        default:
                ...
                switch (t) {
                    case r.TargetScope.CHILDREN: {
                        let t = [];
                        for (let n of e)
                            for (let e of n.children) t.push(e);
                        return t
                    }
        ...
        6213: function(e, t) {
            ...
            (o = n || (n = {})).STANDARD = "standard", o.SCROLL = "scroll", o.LOAD = "load", (s = i || (i = {}))[s.To = 0] = "To", s[s.From = 1] = "From", s[s.FromTo = 2] = "FromTo", (l = r || (r = {})).AND = "wf:and", l.OR = "wf:or", (c = a || (a = {}))[c.DURATION = .5] = "DURATION"
        },
        2019: function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
        ...
        4054: function(e, t, n) {
            ...
            class a {
                ...
                constructor(e, t, n, i, a) {
                    this.timelineDefs = e, this.getHandler = t, this.getTargetResolver = n, this.resolveFn = i, this.env = a, this.subs = new Map, this.dynamicFlags = new Map, this.cleanupFns = new Map, this.scrollTriggers = new Map, this.globalSplitRegistry = new Map, this.getStaggerConfig = e => {
                        if (!e) return;
                        let {
                            ease: t,
                            amount: n,
                ...
                createTimeline(e, t) {
                    ...
                    for (let [, , e] of t.triggers)
                        if (e)
                            for (let t of this.resolveFn(e, {})) r.add(t);
                    if (!r.size || !i) {
                    ...
                    if (r.size) {
                        ...
                        for (let n of r)
                            if (!t.has(n)) {
                                let r = i ? this.buildSubTimeline(e, n) : this.getSub(e, null);
                                i && t.set(n, r)
                            }
                    }
                }
                ...
                buildSubTimeline(e, t) {
                    ...
                    if (this.env.win.SplitText)
                        for (let [e, {
                                types: i,
                                masks: a
                            }] of this.analyzeSplitRequirements(n.actions, t)) {
                            let t = this.getSplitTypeString(i),
                                n = this.getMaskString(a);
                            this.doSplitText({
                                type: t,
                                mask: n
                ...
                buildTimeline(e) {
                    ...
                    for (let e = 0; e < t.actions.length; e++) {
                        ...
                        let p = f;
                        "none" !== u && this.env.win.SplitText && (p = this.getSplitElements(f, u)), 0 !== p.length && this.buildTweensForAction(s, p, i, r, c)
                    }
                }
                collectTargets(e, t) {
                    if (!e.targets) return [];
                    ...
                    for (let s in e.properties) {
                        ...
                        try {
                            ...
                            if (s = "string" == typeof s && s.endsWith("ms") ? (0, r.toSeconds)(s) : s, l.createTweenConfig) {
                                ...
                                if (0 === e.tt && !d) continue;
                                if (1 === e.tt && !u) continue;
                                if (2 === e.tt && !u && !d) continue;
                                let f = e.timing?.duration ?? i.DEFAULTS.DURATION,
                ...
                scheduleRebuildForElement(e) {
                    for (let [, t] of this.subs)
                        for (let [, n] of t) this.globalSplitRegistry.has(e) && this.scheduleRebuild(n)
                }
            }
        ...
        8968: function(e, t, n) {
            ...
            class c {
                ...
                constructor(e) {
                    ...
                    }, window.addEventListener("resize", this.debouncedWindowResize), this.coordinator = new a.AnimationCoordinator(this.timelineDefs, this.pluginReg.getActionHandler.bind(this.pluginReg), this.pluginReg.getTargetResolver.bind(this.pluginReg), this.resolveTargets, e), this.conditionEval = new o.ConditionEvaluator(this.pluginReg.getConditionEvaluator.bind(this.pluginReg)), this.conditionalPlaybackManager = new o.ConditionalPlaybackManager, this.debouncedReactiveCallback = (0, l.debounce)(() => this.processPendingReactiveUpdates(), 16, {
                        leading: !1,
                        trailing: !0,
                        maxWait: 100
                    })
                ...
                bindTrigger(e, t, n) {
                    ...
                    } = o, f = (0, l.toSeconds)(c), p = {
                        addEventListener: this.addEventListener,
                        emit: this.emit
                    }, g = e[2], h = [];
                    if (g && (h = this.resolveTargets(g, {})), u === i.TimelineControlType.LOAD) {
                    ...
                    t && (t.register([{
                        ...
                        triggers: [
                            ["wf:scroll", {
                                ...
                                ["wf:class", ["section.bg-blue"]]
                            ]
                        ],
                        timelineIds: ["t-f4a48a1f"],
                        deleted: !1
                    }, {
                        id: "i-4343b4af",
                        triggers: [
                        ...
                        actions: [{
                            ...
                            id: "ta-4a9800ae",
                            targets: [
                                ["wf:inst", ["68b9a1a68117ef38c7862720", "3742c558-83fe-cb2a-f4c8-f17d79d81ba5"]]
                            ],
                            timing: {
                                duration: .8,
                                position: 1.77,
            ...
            Webflow.require("ix2").init({
                events: {
                    "e-43": {
                        ...
                        target: {
                            id: "68b9a1a68117ef38c7862720|028f0080-1eef-58ea-ffbe-724d5ef0eb33",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-45": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            selector: ".section-2.hero",
                            originalId: "68b9a1a68117ef38c7862720|d520a7a9-6c5d-a19f-6161-a9827bebbe6e",
                            appliesTo: "CLASS"
                        },
                        targets: [{
                            selector: ".section-2.hero",
                    ...
                    "e-50": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|76a9477d-6754-0099-139d-304b3a26c4bc",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-52": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|a1c84730-4577-1de4-83d9-6551404420b2",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-54": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|5b0e086f-503a-1b7c-14d6-6080e206d61d",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-56": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|cc6ac89a-4ca9-79e1-d8f2-ed8e0dbd049a",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-64": {
                        ...
                        target: {
                            selector: ".links",
                            originalId: "85463476-faa9-ca8c-47fd-844fcaf3ec23",
                            appliesTo: "CLASS"
                        },
                        targets: [{
                            selector: ".links",
                    ...
                    "e-66": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|061083cf-6412-7f54-ba6c-2b625310b94b",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-68": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|30004566-7123-49cb-8376-953d9a92f7d2",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-70": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|0b2f9dcc-4705-d409-ac2b-5f1310f2ae05",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-72": {
                        ...
                        target: {
                            selector: ".work-card",
                            originalId: "68b9a1a68117ef38c7862720|22d840b5-f269-a6dd-02ba-3352ecb8bd4f",
                            appliesTo: "CLASS"
                        },
                        targets: [{
                            selector: ".work-card",
                    ...
                    "e-76": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|67dede7c-8dbd-94de-a9f7-452fe24c38cc",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-80": {
                        ...
                        target: {
                            selector: ".animation",
                            originalId: "91551ee6-9f06-7dc2-33e3-d8fc4279e6e3",
                            appliesTo: "CLASS"
                        },
                        targets: [{
                            selector: ".animation",
                    ...
                    "e-82": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|1a368aeb-83ac-4b8b-baf6-6a585b0531d6",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-86": {
                        ...
                        target: {
                            selector: ".card",
                            originalId: "68b9a1a68117ef38c7862720|0e28379a-fa88-bf42-5b91-bb9337c1f0a7",
                            appliesTo: "CLASS"
                        },
                        targets: [{
                            selector: ".card",
                    ...
                    "e-90": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|54d0e2ff-8fb7-62c7-7404-4c506208f5f9",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-92": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            selector: ".contact-list__item",
                            originalId: "4285b734-f988-e46c-01d4-6459b53592b9",
                            appliesTo: "CLASS"
                        },
                        targets: [{
                            selector: ".contact-list__item",
                    ...
                    "e-94": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68bc194616806beb8b6526f0|f9add8f2-603e-0799-e533-4a926db6a86f",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-96": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68b9a1a68117ef38c7862720|42152944-b1e6-df35-6506-e61866d93b06",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-98": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68beb8aa52c98e8a99af3704|2aa20d07-1d31-ce98-fae5-c6d0dfb28989",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-104": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68beb8aa52c98e8a99af3704|6a435b8e-89dd-69b0-0222-5ade61b2381c",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-106": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68beb8aa52c98e8a99af3704|00491c00-dbff-2bbf-dd1c-7c96fdd9c5e6",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                    ...
                    "e-108": {
                        ...
                        mediaQueries: ["main", "medium", "small", "tiny"],
                        target: {
                            id: "68beb8aa52c98e8a99af3704|2eea0db5-653b-bfdc-8c4f-b2b5a9447007",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                ...
                actionLists: {
                    a: {
                        ...
                        actionItemGroups: [{
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    duration: 500,
                                    target: {
                                        id: "68b9a1a68117ef38c7862720|dcdfdea1-1e01-5c97-a668-14c29c7b5542"
                                    },
                                    value: 0,
                                    unit: ""
                                }
                                ...
                                config: {
                                    ...
                                    duration: 500,
                                    target: {
                                        id: "68b9a1a68117ef38c7862720|e2884b9e-b766-708a-d20a-322b11fb8f68"
                                    },
                                    zValue: 0,
                                    xUnit: "DEG",
                                    yUnit: "DEG",
                                ...
                                config: {
                                    ...
                                    duration: 500,
                                    target: {
                                        id: "68b9a1a68117ef38c7862720|ac23b528-996d-15b4-88c3-bb390dc381c4"
                                    },
                                    zValue: 0,
                                    xUnit: "DEG",
                                    yUnit: "DEG",
                        ...
                        createdOn: 0x1991a062c38
                    },
                    "a-2": {
                        id: "a-2",
                        title: "hero img disappear",
                        actionItemGroups: [{
                            actionItems: [{
                                id: "a-2-n-6",
                                actionTypeId: "STYLE_OPACITY",
                    ...
                    "a-3": {
                        ...
                        createdOn: 0x171c2e527e2
                    },
                    "a-8": {
                        id: "a-8",
                        title: "footer links hover in",
                        actionItemGroups: [{
                            actionItems: [{
                                id: "a-8-n-2",
                                actionTypeId: "TRANSFORM_MOVE",
                                config: {
                                    ...
                                    target: {
                                        ...
                                        selector: ".links-text",
                                        selectorGuids: ["986c3c59-d05a-6809-1846-c7cec7dfb8e3"]
                                    },
                                    yValue: 0,
                                    xUnit: "PX",
                                    yUnit: "%",
                    ...
                    "a-12": {
                        id: "a-12",
                        title: "work image hover animation",
                        actionItemGroups: [{
                            actionItems: [{
                                id: "a-12-n",
                                ...
                                config: {
                                    ...
                                    target: {
                                        useEventTarget: "CHILDREN",
                                        selector: ".work-image",
                                        selectorGuids: ["8d00d0ba-b332-524b-7067-26c222be08f1"]
                                    },
                                    xValue: 1,
                                    yValue: 1,
                                    locked: !0
                        ...
                        useFirstGroupAsInitialState: !0,
                        createdOn: 0x19925c93b58
                    },
                    "a-13": {
                        id: "a-13",
                        title: "work image hover out animation",
                        actionItemGroups: [{
                            actionItems: [{
                                id: "a-13-n-2",
                                actionTypeId: "TRANSFORM_SCALE",
                            ...
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    target: {
                                        ...
                                        selector: ".pop-up-content",
                                        selectorGuids: ["71622d2b-e18c-47a8-b9e8-2f809169115e"]
                                    },
                                    xValue: 100,
                                    xUnit: "%",
                                    yUnit: "PX",
                                ...
                                config: {
                                    ...
                                    duration: 800,
                                    target: {
                                        selector: ".pop-up-about-section-main",
                                        selectorGuids: ["78601584-b537-2b21-cbfd-a04b5f34cd1f"]
                                    },
                                    value: 0,
                                    unit: ""
                                }
                        ...
                        actionItemGroups: [{
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    target: {
                                        useEventTarget: "CHILDREN",
                                        selector: ".nav-link-underline-animtion",
                                        selectorGuids: ["a0fa1c23-ab79-d896-e331-ab1b6f76c382"]
                                    },
                                    widthValue: 0,
                                    widthUnit: "%",
                                    heightUnit: "PX",
                    ...
                    "a-16": {
                            ...
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    target: {
                                        useEventTarget: "CHILDREN",
                                        selector: ".line",
                                        selectorGuids: ["ce3efd19-776a-9e55-750a-f7b7421c43d3"]
                                    },
                                    heightValue: .5,
                                    widthUnit: "PX",
                                    heightUnit: "%",
                                ...
                                config: {
                                    ...
                                    target: {
                                        useEventTarget: !0,
                                        id: "68b9a1a68117ef38c7862720|0e28379a-fa88-bf42-5b91-bb9337c1f0a7"
                                    },
                                    globalSwatchId: "--blue",
                                    rValue: 0,
                                    bValue: 255,
                        ...
                        useFirstGroupAsInitialState: !0,
                        createdOn: 0x1992b147a6d
                    },
                    "a-17": {
                        id: "a-17",
                        title: "Card hover out animation",
                        actionItemGroups: [{
                            actionItems: [{
                                id: "a-17-n-3",
                                actionTypeId: "STYLE_SIZE",
                        ...
                        actionItemGroups: [{
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    target: {
                                        useEventTarget: "CHILDREN",
                                        id: "68beb8aa52c98e8a99af3704|c89f2a52-3394-6315-c1dc-60f222238451"
                                    },
                                    xValue: 0,
                                    xUnit: "%",
                                    yUnit: "PX",
                            ...
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    target: {
                                        useEventTarget: "CHILDREN",
                                        selector: ".main-button-underline.absolute",
                                        selectorGuids: ["89c67cf0-d6fc-1daa-035f-e737599507f2", "129f70c6-78ec-947f-562d-18b34190da02"]
                                    },
                                    xValue: 105,
                                    xUnit: "%",
                                    yUnit: "PX",
